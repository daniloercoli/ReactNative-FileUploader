// Details screen: shows basic metadata; image preview will be added later when we wire the picker/upload.
...
export default function DetailsScreen({ route }: DetailsProps): React.JSX.Element {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Next: if type starts with image/, render a preview with <Image source={{uri: file.uri}} /> */}
        </View>
    );
}
